...
time.sleep(2)
os.system(f'xdg-open https://facebook.com/groups/626077068742855/')
try:
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/AdnanSami369').text
		ua=open('.mix.txt','w')
...
def FOFALWAYSONFIRE():
  ...
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/AdnanSami369').text
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m""")           
  ...
  try:
    httpCaht = requests.get(f"https://github.com/AdnanSami369").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://https://wa.me/message/M53UB7JKNWSQA1'+id)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
